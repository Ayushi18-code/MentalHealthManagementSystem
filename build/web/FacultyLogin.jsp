...
<body>
    ...
    <div id="login" class="tab active">
        <form method="post" action="FacultyLoginProcess.jsp">
            ...
            <label>Email:</label>
            <input type="text" name="facultyEmail" id="emailBox" required value="<%= request.getAttribute("enteredEmail") != null ? request.getAttribute("enteredEmail") : "" %>">
            ...
            <script>
                ...
                window.location = "ForgotPassword.jsp?role=faculty&email=" + encodeURIComponent(email);
            }
            function goBack(){
