...
<div class="grid">
<div class="card" onclick="location.href='CounselorEditProfile.jsp'">
<h3>Account Help</h3>
<p>Manage login, password, and profile settings.</p>
</div>

<div class="card" onclick="location.href='CounselorAppointments.jsp'">
<h3>Appointments</h3>
<p>Booking, rescheduling, and cancellation support.</p>
</div>

<div class="card" onclick="location.href='PrivacyAndSecurity.jsp'">
...
<div class="faq-item">
<b>How do I view my scheduled appointments?</b><br>
You can view all upcoming sessions from the dashboard under the "Appointments" section.
<div class="feedback">
...
<div class="faq-item">
<b>Can I reschedule a student session?</b><br>
Yes, you can reschedule sessions based on availability. Students will be notified via email.
<div class="feedback">
<span>Was this helpful?</span>
<button onclick="handleFeedback(this)">&#128077;</button>
<button onclick="handleFeedback(this)">&#128078;</button>
...
<div class="faq-item">
<b>How do I access student details before a session?</b><br>
Click on the appointment to view basic details and symptoms shared by the student.
<div class="feedback">
<span>Was this helpful?</span>
<button onclick="handleFeedback(this)">&#128077;</button>
<button onclick="handleFeedback(this)">&#128078;</button>
