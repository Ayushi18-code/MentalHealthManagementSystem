...
"a.preferred_mode, a.chief_concern, a.status, n.note_id " +
"FROM APPOINTMENT a " +
"JOIN STUDENT s ON a.student_id = s.student_id " +
"LEFT JOIN SESSION_NOTES n ON a.id = n.appointment_id " +
...
<html>
<head>
    <title>Counselor Session Notes</title>
...
.equal-cols td:nth-child(1) { width: 15%; }   /* Student */
...
.equal-cols td:nth-child(4) { width: 10%; }    /* Time */

.equal-cols th:nth-child(5),
.equal-cols td:nth-child(5) { width: 10%; }   /* Mode */

.equal-cols th:nth-child(6),
.equal-cols td:nth-child(6) { width: 28%; }   /* Concern */

.equal-cols th:nth-child(7),
.equal-cols td:nth-child(7) { width: 15%; text-align:center; } /* Start */
...
if(noteId == 0){   // No notes exist
%>
    <a href="addNotes.jsp?appointmentId=<%= appointmentIdVal %>"
       class="btn btn-primary btn-sm">Add Notes</a>
<%
} else {   // Notes already exist
%>
    <a href="addNotes.jsp?appointmentId=<%= appointmentIdVal %>"
       class="btn btn-success btn-sm">Edit Notes</a>
<%
}
%>
</td>
