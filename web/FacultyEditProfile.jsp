...
<% } %>
    <form method="post" action="FacultyEditProfileProcess.jsp" >

        <label>Full Name</label>
        <input type="text" id="name" name="name" value="<%= facultyName %>" required>

        <label>Email</label>
        <input type="email" value="<%= facultyEmail %>" readonly>
