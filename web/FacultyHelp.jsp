...
<div class="card" onclick="location.href='<%= request.getContextPath() %>/FacultyEditProfile.jsp'">
<h3>Account Help</h3>
<p>Manage login, password, and profile settings.</p>
</div>

<div class="card" onclick="location.href='<%= request.getContextPath() %>/FacultyAppointments.jsp'">
<h3>Appointments</h3>
...
<div class="faq-item">
<b>Can I restrict or suspend user accounts?</b><br>
Accounts can be suspended in case of misuse or policy violations, you need to inform Admin.
<div class="feedback">
...
<div class="faq-item">
<b>Can I access detailed case information?</b><br>
Yes,you can view case details including student symptoms, session history, and therapist notes where applicable.
<div class="feedback">
<span>Was this helpful?</span>
<button onclick="handleFeedback(this)">&#128077;</button>
<button onclick="handleFeedback(this)">&#128078;</button>
...
<div class="faq-item">
<b>Can students access additional mental health resources?</b><br>
Yes, students can access curated mental health resources through the dashboard or by contacting the admin for further support.
<div class="feedback">
<span>Was this helpful?</span>
<button onclick="handleFeedback(this)">&#128077;</button>
<button onclick="handleFeedback(this)">&#128078;</button>
